...
def start_night(chat_id):
    ...
    bot.send_photo(
        chat_id, NIGHT_PHOTO,
        caption=f"🌙✨ <b>{game['day_number']}-tun cho'kdi...</b> ✨🌙\n"
                "Shahar chiroqlari o'chdi, ko'chalar bo'm-bo'sh qoldi. "
                "Faqat qorong'ulikda yashaydiganlar uyg'oq... Guruhda yozish vaqtincha taqiqlanadi. 🥷🔇\n\n"
                "🎭 Maxsus rolga ega o'yinchilar — botning shaxsiy xabarlariga (DM) o'ting, "
                "tanlovingiz o'sha yerda kutilmoqda. Har bir soya o'z ishini bajaradi... 🤖🌌",
...
def resolve_night(chat_id):
    with GAME_LOCK:
        ...
        if qotil_target:
            ...
            apply_kill(game, qotil_target, killed)
...
def start_day(chat_id):
    ...
    bot.send_photo(
        chat_id, DAY_PHOTO,
        caption=f"☀️🌇 <b>{game['day_number']}-kun boshlandi!</b> 🌇☀️\n"
                "Shahar uyg'ondi... Kecha bo'lgan voqealar hali ham havoda hidlanib turibdi. 🕯\n\n"
