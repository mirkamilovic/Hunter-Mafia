...
def _theron_raw_call(system_instruction, user_prompt, history=None, max_tokens=500, temperature=0.9):
    ...
    foydalanuvchiga xom Python xatoligini ko'rsatmaydi."""
    ...
    if last_error:
        _logger.warning("🧠 Theron AI (Gemini) so'rovida xatolik (barcha modellar sinab ko'rildi): %s", last_error)
    else:
        _logger.warning("🧠 Theron AI: ro'yxatdagi HECH BIR model topilmadi (barchasi 404) — GEMINI_MODEL_CANDIDATES ni yangilash kerak bo'lishi mumkin")
    return None
