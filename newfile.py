...
_STATE_INT_KEYED_FIELDS = {"players", "mafia_votes", "votes", "forced_day_votes", "secret_missions", "forced_roles"}
...
def resolve_night(chat_id):
    with GAME_LOCK:
        ...
        if telba_act and telba_act["target"] != "skip" and random.random() < 0.5:
